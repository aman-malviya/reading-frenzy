...
function Latest(){
    ...
    <LatestTile author={posts[1].postAuthor} date={posts[1].postDate} bg='Assets/4.jpg' category={posts[1].postCategory} title={posts[1].postTitle} content={posts[1].postContent.substring(0,200)} />
    </div>
    </div>)
}
