...
function DownCategoryPanel(){
    ...
    <div style={{'width':'100%', 'padding':'2%', 'borderBottom':'1px solid rgba(0,0,0,0.2)','color':'rgba(0,0,0,0.8)'}}>Life Style <span className='forward' style={{'float':'right','opacity':'0.6'}}><ArrowForward style={{'fontSize':'20'}} /></span></div>
    </Link>
