...
function LikedTile(props){
    ...
    <span className='d-flex justify-content-center align-items-center' style={{ 'height':'30px', 'width':'30px', 'border':'1px solid rgba(0,0,0,0.8)', 'borderRadius':'3px', 'transform':'rotate(45deg)'}}><b style={{'transform':'rotate(-45deg)'}}>1</b></span>
    </div>
    <div className='grid-item d-flex align-items-center'>
